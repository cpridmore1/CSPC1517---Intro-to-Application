...
namespace WebApp.SamplePages
{
    public partial class SqlProcQueries : System.Web.UI.Page
    {
        ...
        protected void CategoryProductList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //accessing the data is wholly dependent on the type of data dispaly used in the girdview cell.
            //There are 4 difffrent ways to acess your data (because there are 4 ways to set up your girdview cell. 
            //We have used the generic template technique to create our gridview cell contents
            //Templates allow the developer to place web controls within each cell.
            //When you acess a web control within the gridview cell you will refrence the control type and then use the control type acess technique. 
            ...
            //as a controltype: this indicates the type of web control within the gridview cell that you are touching  
            //(xxxx).Text: indicates the web control acess technique 
